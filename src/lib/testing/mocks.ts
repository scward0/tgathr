...
export const testFixtures = {
  event: {
    ...
    expired: {
      ...
      eventType: 'single-day',
      shareToken: 'test-share-token-expired',
      availabilityStartDate: new Date('2024-01-01'),
      availabilityEndDate: new Date('2024-01-05'),
    ...
    finalized: {
      id: 'event-finalized-999',
      name: 'Finalized Event',
      description: 'This event has been finalized',
      eventType: 'single-day',
      shareToken: 'test-share-token-finalized',
      availabilityStartDate: new Date('2024-01-15'),
      availabilityEndDate: new Date('2024-01-20'),
      preferredTime: 'morning',
      duration: 60,
  ...
  participant: {
    ...
    withSMS: {
      id: 'participant-sms-123',
      name: 'Jane Smith',
      email: 'jane@example.com',
      phoneNumber: '+15551234567',
      token: 'test-token-sms-123',
      smsOptIn: true,
      smsOptInAt: new Date('2024-11-01T12:00:00Z'),
      createdAt: new Date(),
      updatedAt: new Date()
    },
    withoutEmail: {
    ...
    multiple: [
      ...
      },
      {
        ...
        token: 'token-003',
        smsOptIn: true,
        smsOptInAt: new Date('2024-11-01T10:00:00Z'),
        createdAt: new Date(),
        updatedAt: new Date()
      }
    ]
